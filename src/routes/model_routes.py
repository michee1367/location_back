...
@model_api.route('/records/<table_name>/save/<record_id>', methods=['GET'])
def get_save_records_by_tablename(table_name, record_id):
  """
    Show all save records of a table
    ---
    parameters:
      ...
      - name: record_id
        ...
        type: string
        required: true
        description: L'iD de la enregistrement
      - name: is_short
        in: query
        type: boolean
        required: false
...
"""
  return get_save_records_by_table_name(table_name, record_id)
