...
from routes.actions import action_models
...
from services.middleware_entities import init_middlewares_entities
...
app.register_blueprint(kpi, url_prefix='/kpis')
...
app.register_blueprint(action_models, url_prefix='/actions')
